...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'exespoky':
				mainBG = new BGSprite('stageshitlol/HalloweedBG', 0, 0);
				mainBG.scale.set(1.3, 1.3);
				add(mainBG);

				clounds = new BGSprite('stageshitlol/clouds', 0, 0);
				clounds.scale.set(1.3, 1.3);
				add(clounds);

				higuys = new BGSprite('stageshitlol/higuys', 0, 0);
				higuys.scale.set(1.3, 1.3);
				add(higuys);

				idkmou = new BGSprite('stageshitlol/mou', 0, 0);
				idkmou.scale.set(1.3, 1.3);
				add(idkmou);

				idkmou2 = new BGSprite('stageshitlol/mou2scary', 0, 0);
				idkmou2.scale.set(1.3, 1.3);
				add(idkmou2);

				floorlool = new BGSprite('stageshitlol/floor', 0, 0);
				floorlool.scale.set(1.3, 1.3);
				add(floorlool);
